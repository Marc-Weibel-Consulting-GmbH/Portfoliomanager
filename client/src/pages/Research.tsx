      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="text-foreground">Sammle und organisiere deine Investment-Research</p>
          </div>
          <Button onClick={onBackClick} variant="outline" className="gradient-card border-border/50 text-white hover:bg-muted">
            Zurück
          </Button>
        </div>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <Textarea
                  ...
                  className="bg-muted border-border text-white min-h-32"
                />
                <div className="flex gap-4 items-center">
                  <label className="flex-1 cursor-pointer">
                    <div className="flex items-center gap-2 px-4 py-2 bg-muted border border-border rounded hover:bg-slate-600 transition-colors">
          ...
          {researchItems.length === 0 ? (
            <Card className="gradient-card border-border/50">
              <CardContent className="p-8 text-center">
                <p className="text-muted-foreground">Noch keine Research-Einträge vorhanden.</p>
              </CardContent>
            </Card>
          ) : (
            researchItems.map((item: any) => (
              <Card key={item.id} className="gradient-card border-border/50 hover:border-indigo-500 transition-colors">
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        {item.fileType === "text" && <FileText className="w-5 h-5 text-muted-foreground" />}
