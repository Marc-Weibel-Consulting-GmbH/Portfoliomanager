...
import { ArrowLeft, Settings, Shield, Database, FileText, Key, Activity, Grid3x3, PieChart } from "lucide-react";
...
export function Admin({ onBackClick }: AdminProps) {
  ...
  // Only render topbar and overview content when on /admin route
  // Sub-pages (stocks, categories, etc.) render their own full layout
