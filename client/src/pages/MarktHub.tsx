...
import { Globe, Activity, BarChart3, Newspaper, AlertTriangle, TrendingUp, Waves } from "lucide-react";
        ...
        <Tabs value={activeMarktTab} onValueChange={handleMarktTabChange} className="w-full">
          <TabsList className="flex flex-wrap gap-0 bg-transparent border-b border-white/10 p-0 h-auto rounded-none">
            {[
              ...
              { value: "faktoren", label: "Faktoren", icon: TrendingUp },
              { value: "kapitalstroeme", label: "Kapitalströme", icon: Waves },
          ...
          <TabsContent value="kapitalstroeme" className="mt-6">
            <CapitalFlowsContent />
          </TabsContent>
