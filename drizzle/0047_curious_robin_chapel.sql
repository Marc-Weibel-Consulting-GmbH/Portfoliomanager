...
ALTER TABLE `users` DROP COLUMN `hasDemoPortfolio`;--> statement-breakpoint
ALTER TABLE `users` DROP COLUMN `hasCompletedRegistration`;--> statement-breakpoint
ALTER TABLE `users` DROP COLUMN `investmentGoal`;--> statement-breakpoint
ALTER TABLE `users` DROP COLUMN `riskTolerance`;