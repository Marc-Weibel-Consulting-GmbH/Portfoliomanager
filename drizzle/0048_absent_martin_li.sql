...
ALTER TABLE `users` ADD `hasCompletedRegistration` tinyint DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE `users` ADD `investmentGoal` varchar(100);--> statement-breakpoint
ALTER TABLE `users` ADD `riskTolerance` varchar(50);--> statement-breakpoint
