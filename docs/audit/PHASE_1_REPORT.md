...
**Status:** F1-01 und F1-03 verifiziert behoben; F1-02 wartet auf eine separate Produktentscheidung
...
Die geprüften Kernpfade sind **nicht pauschal fehlerhaft**. Die beiden priorisierten Befunde zu Punkt-in-Zeit-Zensur und Sortino-Ratio sind nach Freigabe isoliert behoben und durch Regressionstests abgesichert. Offen bleibt ein Produktvertragskonflikt: Die TTWROR-Kennzahl kappt Tagesrenditen ohne sichtbare Kennzeichnung.
...
| Risiko und Performance | teilweise verifiziert | Target-aware Sortino in Risikostatistik und Modellselektion verifiziert; F1-02 bleibt offen. |
...
Bitte entscheide als nächsten Schritt über **F1-02 TTWROR** oder gib Phase 2 (Security & Governance) frei. Ohne diese Freigabe erfolgen keine weiteren Code- oder Datenänderungen.
