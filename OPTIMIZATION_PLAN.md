...
**Stand:** 2026-07-03 · **Basis:** Vollständiges Read-only-Audit des Repos (Branch `main`, Commit `ed96859`)
**Methodik:** Sechs parallele Tiefenanalysen (Berechnungen, Doppelspurigkeiten, Design/UI, User Flows, Architektur/Fehlerbehandlung, Compliance/Tests); alle als KRITISCH eingestuften Befunde wurden zusätzlich direkt im Code verifiziert. In dieser Phase wurde **kein Produktivcode geändert**.
...
6. R-08 (Smoothing/Fake-Fallback entfernen), R-11 (adjustedClose/Splits), R-12, R-15 … R-23
