...
- [x] Reiner EODHD-Provider-Check für die sechs gesperrten Reihen: GOOGL, NVDA, TSLA und ISRG lieferten jeweils 1'254, NOVO-B.CO 1'252 und ABTC.SW 1'256 Tageszeilen mit 100 % aktuellem `adjusted_close`. Die Lücke ist lokal/importbedingt, nicht providerbedingt. Es wurde kein Preis aktualisiert, überschrieben oder importiert; Audit ergänzt (2026-09-25)
- [x] Nach expliziter Freigabe kontrollierte Anreicherung durchgeführt: Ausschließlich fehlende/0-`adjustedClose`-Werte der zeilenweise identischen Reihen GOOGL (935), NVDA (935), TSLA (935), ISRG (552) und NOVO-B.CO (550) wurden ergänzt; insgesamt 3'907 Werte. Rohkurse und vorhandene positive Adjustierungen blieben unverändert; ABTC.SW wurde wegen einer vorhandenen Adjustierungsabweichung (−9,6037 %) sowie 13 Rohkursabweichungen vollständig gesperrt. Nachprüfung und Liveansicht zeigen fünf vollständige Gesamtrendite-Volatilitäten, ABTC und DBS bleiben Datenlücken. Alias-Priorisierung verhindert zusätzlich, dass die veraltete NVDA.US-Reihe die aktuelle NVDA-Serie verdeckt (2026-09-25)

## Vollständige Aktien-Neuoptimierung: bestätigte Übernahme (2026-09-25)
- [x] Für nicht aktivierte, ledgerfreie Demoportfolios sowohl **«Alle Aktien übernehmen»** als auch je Optimierungstitel **«Übernehmen»** bereitgestellt. Die Gesamtübernahme ersetzt ausschliesslich die Aktienkomponente; Einzelübernahme setzt nur den ausgewählten Zielwert. Cash und Multi-Asset-Sleeves bleiben sichtbar unverändert. Vor jedem Speichern zeigt ein zweiter Dialog die genaue Zielgewichtung, Abweichungen und den Cash-Effekt; der bestehende serverseitige Demo-Rebalancingpfad prüft Eigentümerschaft, Demo-/Live-Status, Ledgerfreiheit, aktuelle Kurse und CHF-FX erneut. Live für «Mami» sowohl Gesamt- (42 Änderungen, Cash 0 PP) als auch Einzelvorschau KREATE.HE (+3.96 PP, Cash −3.96 PP) geöffnet und ohne Speichern geschlossen; keine Portfolio-, Cash-, Ledger-, Transaktions- oder Handelsmutation ausgelöst (2026-09-25)
...
## Volloptimierung: gemeinsame CHF-Renditehistorie (2026-09-25)
- [x] Das Volloptimierungs-Gate bewertet neben der kalenderbasierten Kursabdeckung nun die tatsächlich nach Kurs-, FX- und Kalenderabgleich gemeinsame CHF-Renditeserie. Für 3/5/10 Jahre sind mindestens 85 % der angeforderten Handelstage nötig (756/1’260/2’520 Tage → 643/1’071/2’142). Eine Vorschau mit unzureichender Reihe bleibt sichtbar, ist klar als hypothetische Teilreihe markiert und kann weder einzeln noch gesamthaft übernommen werden. Live validiert: Min. Varianz mit den Zielen Dividendenrendite ≥3.5 %, Volatilität ≤12 %, Sharpe ≥0.70, Drawdown ≤25 %, CHF ≥40 % hatte nur 135 gemeinsame Tage im 5J-Fenster und war korrekt gesperrt; Max-Sharpe wies 1’139 gemeinsame Tage auf und blieb als 5J-Vorschau zulässig. Keine Position, Cashreserve, Buchung, Preisreihe oder Order geändert (2026-09-25)

## Risikoabruf: temporäre Fehler statt falscher Datenlücke (2026-09-25)
- [x] Ursachenanalyse und robustere Anzeige umgesetzt: Ein fehlgeschlagener tRPC-Abruf wurde nach dem Ladezustand bisher wie eine endgültige 5J-Datenlücke dargestellt. Nun sind Laden, Abruffehler, explizit fehlende Serverdaten und echtes 5J-Gate getrennt; es werden nie Nullwerte erfunden, der Abruf versucht bis zu dreimal erneut und Fehlerzustände erhalten eine sichtbare Aktion «Analyse erneut starten». Live für «Mami» nach einem vollständigen Reload validiert: Sharpe −0.11, Benchmark 0.10; Max.-Drawdown −25.6 %, Benchmark −29.3 % (2026-09-25)

> **Status 25.09.2026:** Die noch offenen Selma-Punkte sind auf Nutzerwunsch pausiert. Der öffentliche Web-Einstieg wurde erneut nur lesend geprüft und endet vor Beratung/Anlageprofil an der Cloudflare-Prüfung beziehungsweise am nativen-App-Handoff. Keine Registrierung, Kontoeröffnung, Zahlung oder Vertragsaktion wurde ausgelöst.

## Volloptimierung: Kandidaten-Kurscharts (2026-09-25)
- [x] Der Detaildialog wählt bei historischen US-Tickeraliasen (z.B. `JNJ`/`JNJ.US`) genau eine aktuelle, chronologische Quellreihe statt beide Reihen tagweise zu vermischen. Dadurch sind die Zeitstempel für das Chartmodul eindeutig; JNJ zeigt wieder den Kursverlauf in allen Zeitfenstern. Für abweichende Auslandslisting-/ADR-Preisreihen (z.B. 6856.T über EUR) wird der gespeicherte Chart jetzt lesend gezeigt, aber sichtbar als `EUR-Proxy` mit Ausschluss von Risiko-, Rendite- und Optimierungskennzahlen gekennzeichnet. Nebenbefund behoben: StockLogo führte beim Schliessen eines Detaildialogs bedingt weniger Hooks aus und konnte die Seite in die Fehlergrenze werfen; die Query ist nun stabil deaktiviert statt bedingt ausgelassen. Live an JNJ und Horiba geprüft, inklusive stabilem Schliessen; keine Position, Cashreserve, Buchung, Preisreihe oder Order geändert (2026-09-25)

## Test-Optimierung: dauerhafte Rücknahme (2026-09-25)
- [x] Ursache für die gesperrte Positionslöschung nach dem Testen der Upgrade-Vorschläge behoben: Die Übernahme persistiert korrekt fünf Optimierungs-Kauf-/Verkaufsbuchungen, sodass der sichere Ledger-Guard Einzelpositionslöschungen sperrt; die bisherige Rücknahme erschien aber nur im flüchtigen Erfolgsbanner. Der Transaktionen-Tab zeigt jetzt jede noch offene, als `optimization` markierte Demo-Buchungsgruppe dauerhaft mit einem bestätigungspflichtigen Button **Test zurücknehmen**. Serverseitig darf die Rücknahme nur eine vollständige Gruppe automatischer Kauf-/Verkaufsbuchungen eines nicht aktivierten Demoportfolios betreffen; manuelle Buchungen, Liveportfolios, unvollständige IDs und unbestimmte CHF-Beträge werden abgewiesen. Live an Mami geprüft: eine Gruppe mit fünf Buchungen (SREN.SW, SLHN.SW, GPW.WA, VYM, SRG.MI), Bestätigungsdialog geöffnet und ohne Ausführung geschlossen. Keine Position, Cashreserve, Buchung, Preisreihe oder Order durch diesen Test verändert (2026-09-25)

## Risikoabruf: Dauerladezustand beseitigt (2026-09-25)
- [x] Die Fünfjahres-Risikoabfrage analysiert nun pro Benchmarktag direkt nur die letzte additive Importzeile statt 295'480 historische SMI-Duplikate zu laden; die Rohdaten bleiben vollständig und unverändert. Der reine Benchmarkabruf sank von 3.60 s auf 0.28 s. Ein prozesslokaler Fünf-Minuten-Cache hält nur vollständig qualifizierte, nach Scope/Datum/Portfolio-Revision getrennte Risikoreihen vor und wird mit allen Portfolio-Mutationscaches für den betroffenen Nutzer invalidiert; keine externe Cache-Abhängigkeit kann den Kopf blockieren. Live nach Reload: Sharpe −0.14, Max.-Drawdown −24.9 %, SPI −29.3 %, 1'292 Beobachtungen; kein hängendes «Wird berechnet…». Keine Portfolio-, Cash-, Ledger-, Transaktions-, Preis- oder Handelsmutation (2026-09-25)

## EODHD-Titelsuche und externe Detailcharts (2026-09-25)
- [x] Globale Titelsuche konsequent auf EODHD umgestellt: Suchtreffer werden in kanonische EODHD-Ticker umgewandelt (u.a. `HDV.US`, `WQDS.LSE`), damit ein in der Optimierung vorgeschlagener ETF anschliessend auch gefunden und geöffnet werden kann. Für abweichende ETF-Produktnamen sind bis zu zwei transparente, deterministische Kurzsuchvarianten vorgesehen; der vollständige Suchbegriff «iShares MSCI High Dividend Yield» findet nun u.a. `HDV.US`. Nicht kuratierte Titel werden beim Öffnen nur lesend über EODHD geladen, ohne Aktien-, Preis- oder Portfoliostammdaten anzulegen. Zusätzlich Split-/Klassenwechsel-Guard im Detailchart: Die alte lokale HDV-Reihe (USD 140 → USD 27) wird nicht mehr mit unterschiedlichen Preisbasen verbunden; der Chart verwendet ausschliesslich die homogene, temporäre EODHD-`adjusted_close`-Reihe und zeigt 1J +20.03 % statt einer falschen −76.75 %. Keine Position, Cashreserve, Buchung, Preisreihe oder Order verändert (2026-09-25)
...
## Einzeltitel: kontrollierte EODHD-Historienanreicherung (2026-09-26)
- [x] WM.US-Wurzelursache dokumentiert: EODHD lieferte bereits 1.70% Dividendenrendite und USD 82.7 Mrd. Marktkapitalisierung; der externe Detailpfad skalierte beide Werte fälschlich nochmals. Anzeige nun 1.7% bzw. USD 82.7 Mrd.; PEG bleibt als belegte EODHD-Datenlücke sichtbar.
- [x] Aktiendetail ergänzt: «Historische Daten laden (5J)» schreibt erst nach aktivem Klick EODHD-Stammdaten sowie bis zu fünf Jahre Kurse additiv und berechnet Volatilität/Sharpe nur aus einer homogenen, kalenderbasierten 5J-Reihe. Bestehende historische Werte werden nicht überschrieben.
- [x] «Zur Watchlist» führt zuerst denselben Datenimport aus und kuratiert danach den Titel ausdrücklich; vorhandene EODHD-Kennzahlen werden nicht mehr durch den Yahoo-Fallback überschrieben. Portfolioaufnahme bleibt eine separate, bestätigungspflichtige Aktion. Kein Button wurde im Test ausgelöst und keine Watchlist-, Portfolio-, Cash-, Ledger- oder Handelsmutation durchgeführt.
